...
def parse_directory_listing(url, base_save_dir, visited_urls=None):
    """
    ...
    try:
        ...
        for link in soup.find_all('a', href=True):
            ...
            if href.endswith('/'):
                ...
                parse_directory_listing(full_url, base_save_dir, visited_urls)
...
def main():
    ...
    # Start processing
    parse_directory_listing(args.url, args.output_dir)
